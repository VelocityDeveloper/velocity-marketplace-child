                            ...
                            <div class="row g-4 align-items-stretch">
                                <?php if ($promo_image) : ?>
                                    <div class="<?php echo esc_attr($promo_col_class); ?>">
                                        <a href="<?php echo esc_url($promo_url); ?>" class="d-block text-decoration-none card rounded-4 overflow-hidden h-100">
                                            <div class="ratio ratio-16x9">
                                                <img src="<?php echo esc_url($promo_image); ?>" class="w-100 h-100 object-fit-cover" alt="" loading="lazy" decoding="async">
                                            </div>
                                        </a>
                                    </div>
                                <?php endif; ?>
                                    ...
                                    <div class="<?php echo esc_attr($top_col_class); ?>">
                                        <div class="h-100">
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <h2 class="h3 mb-0"><?php esc_html_e('Produk Terlaris', 'justg'); ?></h2>
                                            </div>
                                            <div class="vmc-product-grid vmc-product-grid--top">
